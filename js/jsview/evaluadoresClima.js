...
$(document).ready(function() {
	...
	//Click a btn Todos los evaluadores o algunos
	...
	$('#form-ajax').on('submit', function() {	
	  ...
	  //Revisamos si esta check el boton de todos evaluacion
	  if (flagTodos)
	  {
	  	console.log("oktodos");
	  	if (accion == "INSERT")
		{
			$.get(urlBase+'index.php/encuestaEvaluadores/insertaEvaluadoresClimaTodos/', dataForm ,function(result){
				console.log(result+'ok');
		    	alert('Se han guardado los registros con exito de todos');
		    	/*if (nuevo){
	  ...
	  else
	  {
			...
			if (accion == "INSERT")
			{
				$.get(urlBase+'index.php/encuestaEvaluadores/insertaEvaluadoresClima/', dataForm, function(result){
					console.log(result+'ok');
